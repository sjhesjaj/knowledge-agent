# Diagnostic report: eval/pmi_qwen_env_v1.json

- dataset: `eval_answerability_validation_v1.json` · labels: `eval/environments/eval-env-v1/labels/validation_v1.labels.json` · traces: `eval/artifacts/pmi_qwen_env_v1/traces.sqlite`
...
- `answer_document_h008` run 1 · trace `727e20f6c30442dc889420885e53159a` · **planning_error** (planning) - signal:requires_freshness: requires_freshness=True, labelled False
    - secondary: evidence_error (policy_outcome) policy refuse with ['freshness_unsupported']
- `answer_document_h008` run 2 · trace `d202f5230c204e9282ef1b6c7d905f7d` · **planning_error** (planning) - signal:requires_freshness: requires_freshness=True, labelled False
    - secondary: evidence_error (policy_outcome) policy refuse with ['freshness_unsupported']
- `answer_document_h008` run 3 · trace `516f944a35d945b395a240a8403e4673` · **planning_error** (planning) - signal:requires_freshness: requires_freshness=True, labelled False
    - secondary: evidence_error (policy_outcome) policy refuse with ['freshness_unsupported']
