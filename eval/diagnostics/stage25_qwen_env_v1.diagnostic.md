# Diagnostic report: eval/stage25_qwen_env_v1.json

- dataset: `eval_answerability_validation_v1.json` · labels: `eval/environments/eval-env-v1/labels/validation_v1.labels.json` · traces: `eval/artifacts/stage25_qwen_env_v1/traces.sqlite`
...
- `answer_document_h008` run 1 · trace `22e6ef4b8d8445729f53ce9edcf44354` · **planning_error** (planning) - signal:requires_freshness: requires_freshness=True, labelled False
    - secondary: evidence_error (policy_outcome) policy refuse with ['freshness_unsupported']
- `answer_document_h008` run 2 · trace `111409a9d2ae4c92a075e42d43263d4f` · **planning_error** (planning) - signal:requires_freshness: requires_freshness=True, labelled False
    - secondary: evidence_error (policy_outcome) policy refuse with ['freshness_unsupported']
- `answer_document_h008` run 3 · trace `9d5a0fed7fe44e4e99588c10aa49c2d7` · **planning_error** (planning) - signal:requires_freshness: requires_freshness=True, labelled False
    - secondary: evidence_error (policy_outcome) policy refuse with ['freshness_unsupported']
